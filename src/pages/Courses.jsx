    ...
    <div className="bg-gradient-to-br from-black via-gray-900 to-slate-900 min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row gap-6 justify-between items-center">
        <input
          ...
          className="w-full md:w-1/3 p-3 rounded-lg bg-black border border-white/20 text-white"
        />
        ...
        <div className="flex gap-4 flex-wrap">
          {["all", "fullstack", "backend", "ai"].map((cat) => (
            <button
              ...
              className="px-5 py-2 rounded-full border border-white/20 hover:bg-indigo-600 transition"
            >
              {cat === "all"
                ? "All"
            ...
            >
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="bg-indigo-600 px-6 py-2 rounded-full font-semibold hover:bg-indigo-700">
                    View Course
                  </button>
                </div>
              </motion.div>
