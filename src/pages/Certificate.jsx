export default function Certificate() {
  return (
    <div className="bg-gradient-to-br from-indigo-600 to-purple-700 py-10 sm:py-20 px-4 sm:px-8">

      {/* Wrapper */}
      <div className="max-w-5xl mx-auto">

        {/* Certificate Card */}
        <div className="bg-white w-full p-5 sm:p-12 rounded-3xl shadow-2xl border-8 border-indigo-600">
          ...
          <div className="text-center px-2 sm:px-10">
            ...
            <h2 className="text-2xl sm:text-5xl font-extrabold text-gray-800 mb-4 sm:mb-6">
            ...
            <h3 className="text-xl sm:text-4xl font-bold text-indigo-600 mb-4 sm:mb-6">
              Prem Mishra
            </h3>
            ...
            <h4 className="text-lg sm:text-3xl font-semibold mb-6 sm:mb-10 text-gray-800">
              MERN Stack Mastery 💻
            </h4>

            {/* Footer Info */}
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-10 mt-8 sm:mt-16">
              ...
              <div className="text-center text-xs sm:text-base">
                <div className="w-32 sm:w-48 border-t-2 border-gray-400 mx-auto mb-2"></div>
            ...
            <div className="mt-8 sm:mt-16">
              <button className="bg-indigo-600 text-white px-8 sm:px-10 py-2 sm:py-3 rounded-full font-bold hover:bg-indigo-700 transition text-sm sm:text-base">
